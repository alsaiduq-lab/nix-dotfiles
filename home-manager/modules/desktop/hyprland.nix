...
in {
  ...
  xdg.configFile."matugen/dms/configs/hyprland.toml".text = ''
    [templates.dmshyprland]
    input_path = '${config.xdg.configHome}/matugen/dms/templates/hyprland.lua'
    output_path = '${config.xdg.configHome}/hypr/dms/colors.lua'
  '';

  xdg.configFile."matugen/dms/templates/hyprland.lua".text = ''
    -- Auto-generated by DMS Matugen; edit the Home Manager template instead.
        ...
        col = {
          active_border = {
            colors = {
              ...
              "rgb({{colors.secondary.default.hex_stripped}})",
